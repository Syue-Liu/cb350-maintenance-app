 ...
 * 此版本依車主實際保養習慣整理：
 * - 日常／基本保養由車主自行處理並獨立追蹤。
 * - 汽門間隙、鏈條滑塊、離合器、較深入的傳動與煞車系統檢查併入「大保養」，交由店家一次處理。
 *
...
(function (global) {
  ...
  const CATEGORIES = [
    ...
    { key: "overall", name: "店家大保養", color: "#4A5560" },
  ];
  ...
  const MAINTENANCE_ITEMS = [
    {
      ...
      note: "每 4,000 km 或每年；首保通常 1,000 km。可自行更換。",
    },
    {
      key: "oilFilter",
      name: "機油濾芯",
      ...
      note: "約每 18,000 km；常見料號 15412-K0N-D01。可自行更換。",
    },
    {
      key: "airFilter",
      name: "空氣濾芯",
      ...
      note: "約每 18,000 km；多塵、潮濕環境提早。可自行檢查／更換。",
    },
    {
      key: "sparkPlug",
      name: "火星塞",
      ...
      note: "約每 12,000 km；常見規格 NGK MR6K-9。可自行更換。",
    },
    {
      key: "chain",
      name: "傳動鏈條",
      category: "drive",
      action: "清洗/潤滑",
      actions: ["清洗/潤滑", "清洗", "潤滑", "調整", "更換", "檢查"],
      frequent: true,
      kmInterval: 1000,
      monthInterval: 0,
      keywords: ["傳動鏈條", "鏈條", "鍊條", "鏈子", "chain", "清鏈", "清洗鏈條", "清洗鍊條", "鏈條上油"],
      note: "每 1,000 km；洗車、雨騎、多塵後也要潤滑。日常清洗鍊條與潤滑自行處理。",
    },
    {
      key: "brakeFluid",
      name: "煞車油",
    ...
    },
    {
      ...
      monthInterval: 0,
      keywords: [
        "大保養", "major service", "汽門間隙", "汽門", "氣門", "鳥仔", "valve clearance", "valve",
        "鏈條滑塊", "鍊條滑塊", "chain slider", "離合器", "離合", "clutch", "傳動系統", "傳動檢查",
        "煞車系統", "剎車系統", "煞車卡鉗", "剎車卡鉗", "卡鉗", "brake system",
        "節流閥", "噴油嘴", "積碳", "燃油清潔", "齒盤"
      ],
      note: "每 20,000 km 交由店家處理：① 汽門間隙檢查／調整；② 傳動系統：清洗鍊條、檢查／調整鍊條張力、鏈條滑塊、前後齒盤與離合器作動；③ 煞車系統：檢查油管、卡鉗、洩漏與煞車手感；④ 節流閥與噴油嘴清潔；⑤ 積碳／燃油系統清潔；⑥ 全車重要固定件與作動檢查。",
    },
  ];
